...
CC="p gcc -m32 -c -I$OBJDIR/include -I$ROOT/include -I$ROOT/utils/include"
LD="p gcc -m32"
AR="p ar crvs"
...
# libbio
cd $ROOT/include/libbio || error cannot find libbio directory
...
# lib9
cd $ROOT/include/lib9 || error cannot find lib9 directory
...
$LD -o mk `ofiles $CFILES` $OBJDIR/lib/libregexp.a $OBJDIR/lib/libbio.a $OBJDIR/lib/lib9.a || error mk link failed
